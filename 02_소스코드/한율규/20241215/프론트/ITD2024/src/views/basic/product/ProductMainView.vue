<template>
  <div class="productMain">
    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="dropdown">
        <button class="btn btn-snow dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
          정렬
        </button>
    ...
    <div class="container text-center" v-if="sortType === 'sales'">
      <div class="row">
        <div class="col-3" v-for="(data, index) in recommendedProducts" :key="index">
          <div class="image-container">
            <router-link :to="'/Pdv/' + data.product.prid" class="routerLink">
              <!-- 이미지 렌더링 -->
              <img :src="data.image || '/path/to/default-image.jpg'" :alt="data.product.name" class="product-image" />
    ...
    <div class="container text-center" v-if="sortType !== 'sales'">
      <div class="row">
        <div class="col-3" v-for="(data, index) in product" :key="index">
          <div class="image-container">
            <router-link :to="'/Pdv/' + data.product.prid" class="routerLink">
              <!-- 이미지 렌더링 -->
              <img :src="data.image || '/path/to/default-image.jpg'" :alt="data.product.name" class="product-image" />
