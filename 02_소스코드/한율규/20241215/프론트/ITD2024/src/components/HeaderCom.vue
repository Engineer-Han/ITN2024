      ...
      <div class="container-fluid position-fixed " style="background-color: white">
        ...
        <div class="collapse navbar-collapse nav-category" id="navbarScroll">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 category-all">
            <li class="nav-item">
              <a class="nav-link active category" aria-current="page" href="/Pmv">전체상품</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active category" aria-current="page" href="/Durumagi">두루마기,도포</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active category" aria-current="page" href="/jeogori">저고리</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active category" aria-current="page" href="/bottoms">바지,치마</a>
            </li>
          </ul>
